...
public class TermLoadServiceLogic implements TermLoadService {
	...
	private static final Set<String> SYMBOLS = Collections.unmodifiableSet(new HashSet<>(Arrays.asList(SYMBOLS_VALUES)));
	
	// Stop words
	private static final String[] STOP_WORDS_VALUES = new String[] {
