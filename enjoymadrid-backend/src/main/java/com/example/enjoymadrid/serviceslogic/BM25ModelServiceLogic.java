...
public class BM25ModelServiceLogic implements ModelService {
	...
	public void calculateScore(Map<String, Map<TouristicPoint, AtomicInteger>> termFreq, AtomicInteger totalDocs, 
			Map<String, AtomicInteger> nTermDocs, Map<TouristicPoint, AtomicInteger> docsLength) {
